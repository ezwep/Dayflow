        ...
        ZStack(alignment: .topTrailing) {
            ...
            Button(action: onClose) {
                Image(systemName: "xmark")
                    ...
                    .foregroundColor(DayflowColors.accent.opacity(0.7))
                ...
                .fill(
                    LinearGradient(
                        gradient: Gradient(stops: [
                            .init(color: DayflowColors.surface, location: 0),
                            .init(color: DayflowColors.surface, location: 0.85)
                        ]),
                        startPoint: .bottom,
                        endPoint: .top
                    )
                ...
                Button {
                    ...
                    HStack(alignment: .top, spacing: 8) {
                        RoundedRectangle(cornerRadius: 2)
                            .stroke(DayflowColors.accent, lineWidth: shareLogs ? 0 : 1)
                            ...
                            .background(
                                RoundedRectangle(cornerRadius: 2)
                                    .fill(shareLogs ? DayflowColors.accent : Color.clear)
                            )
...
extension TimelineFeedbackModal {
    private var categoryTipsIllustration: some View {
        Image("CategoryEditUI")
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 6)
                    .stroke(DayflowColors.surface.opacity(0.7), lineWidth: 0.5)
            )
